        ...
        <q-header>
            <q-toolbar>
                ...
                <q-tabs class="bg-primary text-white" v-if="!$q.platform.is.mobile">
                    ...
                    <q-route-tab v-for="profile in profileStore.profiles" v-bind="profile" :key="profile.id"
                        :name="profile.name" :icon="profile?.icon || 'movie'" :to="'/profile/' + profile.id">
        ...
        <q-drawer v-model="leftDrawerOpen" :class="$q.dark.isActive ? 'bg-grey-9' : 'bg-grey-3'">
            ...
            <q-scroll-area style="height: calc(100% - 150px); margin-top: 150px; border-right: 1px solid #ddd">
                <q-list>
                    ...
                    <q-item clickable v-for="profile in profileStore.profiles" v-bind="profile" :key="profile.id"
                        :name="profile.id" :to="'/profile/' + profile.id">
                        <q-tooltip class="bg-accent">{{ profile.name }}</q-tooltip>
                        <q-item-section avatar>
